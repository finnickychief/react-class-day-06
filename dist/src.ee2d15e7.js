...
},{"./factoryWithTypeCheckers":"../node_modules/prop-types/factoryWithTypeCheckers.js"}],"../src/components/Navbar.js":[function(require,module,exports) {
'use strict';
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'a',
            {
              className: 'nav-link',
              style: linkStyle,
              onClick: props.switchRouteChild.bind(_this, 'viewContacts')
            },
            'View ',
            _react2.default.createElement(
              'span',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'a',
            {
              className: 'nav-link',
              style: linkStyle,
              onClick: props.switchRouteChild.bind(_this, 'addContact')
            },
            'Add'
          )
        )
...
*/
Navbar.propTypes = {
  switchRouteChild: _propTypes2.default.func.isRequired
};

exports.default = Navbar;
},{"react":"../node_modules/react/index.js","prop-types":"../node_modules/prop-types/index.js"}],"../node_modules/uuid/lib/rng-browser.js":[function(require,module,exports) {
...
},{"./v1":"../node_modules/uuid/v1.js","./v4":"../node_modules/uuid/v4.js"}],"../src/components/ContactCard.js":[function(require,module,exports) {
'use strict';
  ...
  _createClass(ContactCard, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'card-header', onClick: this.toggleDetails },
          _react2.default.createElement(
            'h3',
            null,
            contact.name
        ...
        this.state.visible ? _react2.default.createElement(
          ...
          this.props.goToEdit && _react2.default.createElement(
            'button',
            {
          ...
          this.props.deleteContact && _react2.default.createElement(
            'button',
            {
...
ContactCard.propTypes = {
  ...
  goToEdit: _propTypes2.default.func,
  deleteContact: _propTypes2.default.func
};
},{"react":"../node_modules/react/index.js","prop-types":"../node_modules/prop-types/index.js"}],"../src/components/Input.js":[function(require,module,exports) {
'use strict';
...
},{"react":"../node_modules/react/index.js","prop-types":"../node_modules/prop-types/index.js"}],"../src/components/AddContactForm.js":[function(require,module,exports) {
'use strict';
...
var AddContactForm = function (_Component) {
  _inherits(AddContactForm, _Component);
  ...
  function AddContactForm(props) {
    ...
    _this.onSubmit = function (e) {
      ...
      var _this$state = _this.state,
          ...
          dateMet = _this$state.dateMet,
          notes = _this$state.notes;


      var newContact = { name: name, email: email, phone: phone, company: company, dateMet: dateMet, notes: notes };

      _this.props.onSubmitParent(newContact);
    };
...
AddContactForm.propTypes = {
  onSubmitParent: _propTypes2.default.func.isRequired
};

exports.default = AddContactForm;
},{"react":"../node_modules/react/index.js","./Input":"../src/components/Input.js","prop-types":"../node_modules/prop-types/index.js"}],"../src/components/AddEditForm.js":[function(require,module,exports) {
'use strict';
...
var AddEditForm = function (_Component) {
  _inherits(AddEditForm, _Component);

  function AddEditForm(props) {
    _classCallCheck(this, AddEditForm);

    var _this = _possibleConstructorReturn(this, (AddEditForm.__proto__ || Object.getPrototypeOf(AddEditForm)).call(this, props));
    ...
    _this.onSubmit = function (e) {
      ...
      var updateContact = { id: id, name: name, email: email, phone: phone, company: company, dateMet: dateMet, notes: notes };

      _this.props.onSubmitParent(updateContact);
    };
    ...
    _this.state = {
      ...
      phone: _this.props.contact.phone,
      company: _this.props.contact.company,
      dateMet: _this.props.contact.dateMet,
...
exports.default = AddEditForm;
},{"react":"../node_modules/react/index.js","./Input":"../src/components/Input.js","prop-types":"../node_modules/prop-types/index.js"}],"../src/App.js":[function(require,module,exports) {
'use strict';
...
var _ContactCard = require('./components/ContactCard');

var _ContactCard2 = _interopRequireDefault(_ContactCard);

var _AddContactForm = require('./components/AddContactForm');

var _AddContactForm2 = _interopRequireDefault(_AddContactForm);

var _AddEditForm = require('./components/AddEditForm');

var _AddEditForm2 = _interopRequireDefault(_AddEditForm);
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.switchRouteParent = function (route) {
      _this.setState({ route: route });
    };

    _this.onSubmit = function (newContact) {
      //const newContacts = this.state.contacts.concat([newContact]);

      var newContacts = _this.state.contacts;
      newContacts.push(newContact);

      _this.setState({ contacts: newContacts });
      _this.switchRouteParent('viewContacts');
    };

    _this.onEditSubmit = function (updateContact) {
      // find item to update

      var selectContactIndex = _this.state.contacts.findIndex(function (contact) {
        return contact.id === updateContact.id;
      });
      ...
      // replace them
      var contactsArry = _this.state.contacts;

      contactsArry[selectContactIndex] = updateContact;

      // update state

      _this.setState({ contacts: contactsArry });
      _this.switchRouteParent('viewContacts');
    };

    _this.goToEdit = function (contact) {
      _this.setState({ currentContact: contact });

      // Route to AddEditForm
      _this.switchRouteParent('AddEditForm');
    };

    _this.deleteContact = function (contact) {
      var newArray = _this.state.contacts;
      var selectContactIndex = void 0;
      for (var i = 0; i < _this.state.contacts.length; i++) {
        if (contact.id === _this.state.contacts[i].id) {
          selectContactIndex = i;
        }
      }
      newArray.splice(selectContactIndex, 1);
      _this.setState({ contacts: newArray });
    };
    ...
    value: function render() {
      ...
      switch (this.state.route) {
        case 'viewContacts':
          ...
          break;
        case 'addContact':
          element = _react2.default.createElement(_AddContactForm2.default, { onSubmitParent: this.onSubmit });
          break;
        case 'AddEditForm':
          element = _react2.default.createElement(_AddEditForm2.default, {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_Navbar2.default, { switchRouteChild: this.switchRouteParent }),
        _react2.default.createElement(
          'div',
          { className: 'container' },
          element
...
exports.default = App;
},{"react":"../node_modules/react/index.js","./components/Navbar":"../src/components/Navbar.js","uuid":"../node_modules/uuid/index.js","./components/ContactCard":"../src/components/ContactCard.js","./components/AddContactForm":"../src/components/AddContactForm.js","./components/AddEditForm":"../src/components/AddEditForm.js"}],"../src/index.js":[function(require,module,exports) {
'use strict';
...
//# sourceMappingURL=/src.ee2d15e7.map